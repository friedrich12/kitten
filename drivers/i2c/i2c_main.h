...
#include <lwk/byteorder/swab.h> /* for swab16 */
...
struct i2c_driver {
	...
	int (*command)(struct i2c_client *client, unsigned int cmd, void *arg);
        ...
        /* TODO: Replace with struct driver in lwk/driver.h */
        /* The device driver-model tracks all of the drivers known to the system.
         * This allows the driver core to match up drivers with new devices.
         * Device drivers can export information and configuartion variables that are
         * independednt of any specific device.
...
/* Our bus doesn't support i2c slaves so ignore it */
